...
// String ID_DEVICE;
// String TYPE_DEVICE = "TRANSFORM";
// bool STATUS_PIN = false;
// int VALUE_TRANSFORM = 0;
...
// // => DIMMER
// dimmerLamp dimmer(PIN_DUTY, PIN_ZERO);
...
//   {
//     JsonFixNode.add("value", VALUE_TRANSFORM);
//   }
...
//   {
//     int valueFB = fbdo.to<int>();
//     if (valueFB != VALUE_TRANSFORM && valueFB >= 0 && valueFB <= 100)
//     {
//       // controll dimmer value
//       Serial.println(String("[DIMMER_VALUE] = " + String(valueFB) + "%"));
//       dimmer.setPower(valueFB);
//       VALUE_TRANSFORM = valueFB;
//     }
//   }
// }
...
//   // handle init value 
//   // analogWrite(PIN_DUTY, VALUE_TRANSFORM);
// }
